...
- **Frontend Standard:** 
  - [Bulletproof React 공식 GitHub](https://github.com/alan2207/bulletproof-react) (기능 중심 폴더 구조의 글로벌 스탠다드 템플릿)
  - [Feature-Sliced Design (FSD)](https://feature-sliced.design/) (단방향 의존성과 높은 응집도를 위한 아키텍처 철학)
- **Backend Standard:**
  ...
  - [FastAPI Official: Bigger Applications](https://fastapi.tiangolo.com/tutorial/bigger-applications/) (`APIRouter`를 활용한 공식 대규모 앱 모듈화 가이드라인)