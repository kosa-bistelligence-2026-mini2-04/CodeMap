...
class CodeMapException(Exception):
    ...
    def __init__(self, status_code: int, error_code: str, message: str, data: dict | None = None):
...
# ======================================================================
# API-002: 사전 검증 관련 예외
# 저장소 파일 수 및 용량 사전 검증 실패 시 발생 (500)
# ======================================================================
class ValidationFailedError(CodeMapException):
    ...
    def __init__(self, message: str = "저장소 크기 사전 검증에 실패했습니다. 잠시 후 다시 시도해 주세요.", data: dict | None = None):
        ...
        super().__init__(500, "VALIDATION_FAILED", message, default_data)
...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    async def codemap_exception_handler(
        ...
        ## 예외 객체에 추가 데이터가 정의되어 있는 경우 포함하여 반환
