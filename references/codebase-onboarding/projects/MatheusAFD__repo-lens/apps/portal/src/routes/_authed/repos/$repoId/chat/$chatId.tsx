...
export const Route = createFileRoute('/_authed/repos/$repoId/chat/$chatId' as never)({
  component: ChatRouteDetail,
})

function ChatRouteDetail() {
  ...
  return <ChatPage repo={repo} chatId={chatId} />
}
