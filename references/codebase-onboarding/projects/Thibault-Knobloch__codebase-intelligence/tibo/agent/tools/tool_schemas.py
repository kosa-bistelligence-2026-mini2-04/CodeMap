...
},
{
    ...
    "input_schema": {
        ...
        "properties": {
            "file_path": {
                "type": "string",
                "description": "REQUIRED.The absolute path to the file to modify"
            },
            "action": {
                "type": "string",
                "enum": ["insert", "delete", "update"],
                "description": "REQUIRED. The modification action to perform: 'insert' to add new lines, 'delete' to remove lines, 'update' to modify lines."
            },
            "from_line": {
                "type": "integer",
                "minimum": 0,
                "description": "REQUIRED. The starting line number (0 indexed) of the range to modify."
            },
            "to_line": {
                "type": "integer",
                "minimum": 0,
                "description": "REQUIRED.The ending line number (0 indexed) of the range to modify."
            },
            "new_content": {
                "type": ["string", "array"],
                "items": {
        ...
        "required": ["file_path", "action", "from_line", "to_line"],
        "dependencies": {
            "new_content": {
                "oneOf": [
                    {
