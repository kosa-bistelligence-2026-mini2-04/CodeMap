// Mirrors backend Pydantic v2 schemas (see docs/API-CONTRACT.md).
...
// Model IDs are provider-specific strings now (not a closed enum). The
// frontend fetches the live catalog from GET /api/models on mount.
